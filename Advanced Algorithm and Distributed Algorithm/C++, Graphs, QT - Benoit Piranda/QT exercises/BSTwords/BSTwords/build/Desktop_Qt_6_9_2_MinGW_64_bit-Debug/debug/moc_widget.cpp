...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "on_pb_parent_clicked",
        "on_pb_insert_clicked",
        "on_entry_returnPressed"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_pb_search_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pb_parent_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pb_insert_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_entry_returnPressed'
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pb_parent_clicked(); break;
        case 2: _t->on_pb_insert_clicked(); break;
        case 3: _t->on_entry_returnPressed(); break;
        default: ;
        }
    }
    (void)_a;
